...
class DatabaseHelperRestUsuario {
  var uriREST = Uri.parse('http://192.168.0.105:8080/usuario');
  ...
  excluir(int id) async {
    var uri = Uri.parse('http://192.168.0.105:8080/usuario/$id');
  ...
  Future<bool> login(String email, String password) async {
    //var url = "/login";
    var uriREST2 = Uri.parse('http://192.168.0.105:8080/usuario/login');
    ...
    var response = await http.post(uriREST2, headers: header, body: _body);
  ...
  Future<bool> loginJwt(String email, String password) async {
    var uriREST2 = Uri.parse('http://192.168.0.105:8080/api/auth/signin');
    var header = {'Content-Type': 'application/json'};
